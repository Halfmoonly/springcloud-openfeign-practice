package org.lyflexi.customcloudfeignapi.holder;
...
public class ProjectContextHolder {
     ...
     * @return
     */
    public static ProjectContextHolder getInstance() {
    ...
    private static class SingletonHolder {
        private static final ProjectContextHolder S_INSTANCE = new ProjectContextHolder();
    }
    ...
    public LoginUserVo getContext() {
        ...
        if(systemTask && Objects.isNull(loginUserVo)){
            ...
            ProjectContextHolder.getInstance().setContext(loginUserVo);
        }
        return loginUserVo;
    }
